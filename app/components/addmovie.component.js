        ...
        execute: function() {
            AddMovieComponent = (function () {
                ...
                AddMovieComponent.prototype.ngOnInit = function () {
                    ...
                    this.newMovie = new movie_1.Movie(0, this._routeParams.get("image"), this._routeParams.get("title"), this._routeParams.get("made"), this._routeParams.get("year"));
                };
...
//# sourceMappingURL=addmovie.component.js.map